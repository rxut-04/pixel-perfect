  ...
  return (
    <section className="py-12 sm:py-16 md:py-20 lg:py-24">
      <div className="container flex flex-col items-center text-center px-4">
        <h2 className="my-4 sm:my-6 text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-pretty text-primary">
          {heading}
        </h2>
      </div>
      <div className="pt-6 sm:pt-8 md:pt-12 lg:pt-16 xl:pt-20">
        <div className="relative mx-auto flex items-center justify-center lg:max-w-5xl px-4">
          <Carousel
            opts={{ loop: true }}
          ...
          >
            <CarouselContent className="ml-0">
              {logos.map((logo) => (
                <CarouselItem
                  key={logo.id}
                  className="flex basis-1/2 sm:basis-1/3 justify-center pl-0 md:basis-1/4 lg:basis-1/5 xl:basis-1/6"
                >
          ...
          <div className="absolute inset-y-0 left-0 w-12 bg-gradient-to-r from-background via-background/50 to-transparent pointer-events-none"></div>
          <div className="absolute inset-y-0 right-0 w-12 bg-gradient-to-l from-background via-background/50 to-transparent pointer-events-none"></div>
        </div>
      </div>
    </section>
  );
